...
public class BaseDialogPresenter extends Presenter<BaseDialogContract.View> implements BaseDialogContract.Presenter {
    ...
    @Override
    public void onContentChange(@NonNull final View view) {
        content = view;
        requestRender();
    }

    @Override
    public void onSeverityChange(@NonNull final Severity severity) {
        this.severity = severity;
        requestRender();
    }

    @Override
    public void onTitleChange(@NonNull final String title) {
        this.title = title;
        requestRender();
    }
