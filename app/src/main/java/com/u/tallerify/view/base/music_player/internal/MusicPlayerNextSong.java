 ...
 */
public class MusicPlayerNextSong extends LinearLayout {

    private @NonNull SimpleDraweeView imageView;
    private @NonNull TextView titleView;

    public MusicPlayerNextSong(final Context context) {
        this(context, null);
    }

    public MusicPlayerNextSong(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MusicPlayerNextSong(final Context context, final AttributeSet attrs, final int defStyleAttr) {
