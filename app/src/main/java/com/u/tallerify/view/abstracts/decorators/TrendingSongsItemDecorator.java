package com.u.tallerify.view.abstracts.decorators;
 ...
 */
public class TrendingSongsItemDecorator extends RecyclerView.ItemDecoration {

    private int space;

    public TrendingSongsItemDecorator(int space) {
        this.space = space;
    }
